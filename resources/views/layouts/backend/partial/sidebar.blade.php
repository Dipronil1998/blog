            ...
            <div class="menu">
                <ul class="list">
                    ...
                    @if(Request::is('admin*'))
                        ...
                        <li><strong>Last sign in:</strong>{{ Auth()->user()->last_sign_in_at->diffForHumans() }}</li>
                        <li><strong>Current sign in:</strong>{{ Auth()->user()->current_sign_in_at->diffForHumans() }}</li>
                    @endif
