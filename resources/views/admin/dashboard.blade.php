                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($post->status == true && $post->is_approved == true)
                                                    <!--a class="btn btn-sm btn-primary waves-effect"  href="{{ route('post.details',$post->slug) }}">View</a-->
                                                    <a class="btn btn-sm btn-primary waves-effect"  href="{{ route('post.details',$post->slug) }}"><i class="material-icons">visibility</i></a>
                                                @else
                                ...
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        @foreach($active_authors as $key=>$author)
                                            <tr>
                                                <td>{{$key+1}}</td>
                                                <td><img src="{{asset('/storage/profile/'.$author->image)}}" width="55" height="55"></td>
                                                <td>{{ $author->name }}</td>
                                                ...
                                                <td>
                                                    @if($author->isOnline())
                                                        <li class="label bg-green">
                                                            Online
                                                        </li>
                                                    @else
                                                        <li class="label bg-red">
                                                            Offline
                                                        </li>
                                                    @endif
                                                </td>
